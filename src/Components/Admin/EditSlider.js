...
export const EditSlider = (props) => {
    ...
    const showModal = () => {
      ...
      const submitHandler = async (e) => {
          ...
          data.append('imgId', props.imgId);
          data.append('cloudId', props.cloudId);
        await axios.post('/api/home/slider/edit', data, {headers : {
    ...
    return (
        <span>
           ...
           <Link onClick = {showModal} style={{ textDecoration: 'none' }}><EditOutlined /></Link>  &nbsp;
