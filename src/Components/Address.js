...
export const Address = (props) => {
    ...
    const moveToPayment = async () => {
       ...
       await sendingAddressSuccess ? isAuthenticated() ? props.history.push('/checkout/payment') : props.history.push('/login') 
       :
       swal('Note!', 'Select Address', 'warning')
    }
        ...
        <div className = 'row address'>
            <div className = 'col-md-8' style = {{display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '32px', paddingLeft: '82px'}}>
             ...
             <div className="row p-3">
              ...
              {!isModalVisible && sideProductDetails()}
...
*************************************************************************************************************/ 
  const getAddresses = () => {
         return(
             <div className = 'row' style = {{marginTop: '32px', paddingLeft: '82px'}} >
                 <div className = 'col-md-8'>
               <div className="jumbotron jumbotron-fluid mt-4" style = {{float: 'left', width: '50vw', marginLeft: '100px'}}>
                    <div className = 'row'>
                        <div className = 'col-sm-9'><p style = {{color: '#282c3f', fontSize: '18px', fontWeight: '600'}}>Select Delivery Address</p> </div>
                    ...
                    <p style = {{fontSize: '14px', fontWeight: '600', color: '#535766'}}>DEFAULT ADDRESS</p>
                ...
                
                          {
                             fetchedAddresses && fetchedAddresses.map(add => {
                                  return(
                                    <div key = {add._id} className="jumbotron jumbotron-fluid" style = {{float: 'left', width: '50vw', marginLeft: '100px' ,boxShadow: '0 0 4px rgb(40 44 63 / 8%)', border: '1px solid #eaeaec',padding: '19px 16px 0 48px', marginBottom: '8px', verticalAlign: 'top', borderRadius: '4px'
                                }}>
                                    <div className="row address">
    ...
    return (
        <CartLayout breadcrumb current = "2">
             {  loading 
                ?
